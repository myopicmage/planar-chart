...
var chart = (function () {
    ...
    function create_then_block(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(i, file$2, 86, 6, 2013);
    			attr_dev(button, "type", "button");
    			add_location(button, file$2, 87, 6, 2047);
    			attr_dev(div, "id", "connected-box");
    			attr_dev(div, "class", "success svelte-2acrpo");
    			add_location(div, file$2, 85, 4, 1965);
    		},
    		m: function mount(target, anchor) {
    ...
    // (81:21)       <div id="connected-box">        <i class="fa fa-spinner"></i>      </div>    {:then _}
    function create_pending_block(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(i, file$2, 82, 6, 1905);
    			attr_dev(div, "id", "connected-box");
    			attr_dev(div, "class", "svelte-2acrpo");
    			add_location(div, file$2, 81, 4, 1873);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, div, anchor);
    			append_dev(div, i);
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "pending",
    		source: "(81:21)       <div id=\\\"connected-box\\\">        <i class=\\\"fa fa-spinner\\\"></i>      </div>    {:then _}",
    		ctx
    	});
    ...
    function create_else_block$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(button, file$2, 110, 10, 2741);
    			add_location(p, file$2, 109, 8, 2726);
    			attr_dev(div0, "class", "large-description svelte-2acrpo");
    			add_location(div0, file$2, 102, 6, 2479);
    			attr_dev(div1, "class", "large-description-container svelte-2acrpo");
    			add_location(div1, file$2, 101, 4, 2430);
    		},
    		m: function mount(target, anchor) {
    ...
    function create_if_block$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(span, file$2, 93, 4, 2181);
    		},
    		m: function mount(target, anchor) {
    ...
    function create_else_block_1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			p = element("p");
    			t2 = text(t2_value);
    			add_location(h2, file$2, 106, 10, 2628);
    			add_location(p, file$2, 107, 10, 2668);
    		},
    		m: function mount(target, anchor) {
    ...
    function create_if_block_2(ctx) {
    	...
    	const block = {
    		c: function create() {
    			i = element("i");
    			attr_dev(i, "class", "fa fa-lock");
    			add_location(i, file$2, 104, 10, 2573);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, i, anchor);
    		},
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "if",
    		source: "(104:8) {#if currentPlane.locked}",
    		ctx
    	});
    ...
    function create_if_block_1$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(div, "class", "svelte-2acrpo");
    			add_location(div, file$2, 97, 8, 2316);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, div, anchor);
    			append_dev(div, t);
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "if",
    		source: "(97:6) {#if descriptionText}",
    		ctx
    	});
    ...
    function create_fragment$2(ctx) {
    	...
    	handle_promise(promise = /*connection*/ ctx[6], info);
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(main, file$2, 79, 0, 1824);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    function instance$2($$self, $$props, $$invalidate) {
    	...
    	$$self.$inject_state = $$props => {
    		if ("connection" in $$props) $$invalidate(6, connection = $$props.connection);
